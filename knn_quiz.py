...
class KNN(object):
    ...
    def roc(self, expfile, sampfile, k, fn):
        ...
        one_minus_specs = []
        for value in fn:
            for sens, spec in self.calc_metrics(k, value):
                senses.append(sens)
                one_minus_specs.append(1 - spec)
    ...
    def get_assignments(self, k: int, fn):
        """
    ...
    def calc_metrics(self, k: int, fn):
        """
